...
pipeline{
    ...
    stages {
            ...
            steps {
                ...
                script {
                    ...
                    if (podExists) {
                        ...
                        sh """ssh $User_Name@$KubeM_Pvt_IP kubectl apply -f cozastoredeploy.yaml"""
                        sleep 5
                    ...
                    sleep 15
                    echo "http://${env.KubeW01_Pub_IP}:30018"
                    echo "http://${env.KubeW02_Pub_IP}:30018"
                    Deploy_Main = true
                }
            }
            post{
        ...
        stage ('Cleaning_Production_Workspace'){
            ...
            steps{
                echo '**********Cleaning Cozastore Production workspace**********'
                cleanWs()
                deleteDir()
            }
        }
